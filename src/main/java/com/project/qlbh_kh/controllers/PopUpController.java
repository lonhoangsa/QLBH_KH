...
import com.project.qlbh_kh.controllers.TaoHoaDonController;
...
public class PopUpController {
    ...
    @FXML
    private TableColumn<Product, String> nameColumn; // Cột tên mặt hàng

    @FXML
    private TableColumn<Product, Integer> priceColumn; // Cột giá

    private ObservableList<Product> availableProducts; // Danh sách mặt hàng

    private TaoHoaDonController helloController;

    public void setHelloController(TaoHoaDonController controller) {
